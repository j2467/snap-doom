...
*   [x] Comes with 10 popular mods. More can be added easily. 
*   [x] On a new system, will install and config gzdoom.
*   [x] launcher can be launched by terminal using keyword `snapdoom`
